...
```{r project.setup, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
#Import libraries
...
```{r Ozone2018, echo=FALSE, message=FALSE, warning=FALSE,  fig.align='left', fig.height= 3, fig.cap= "Ozone 2018"}
# Filter records for 2018
ozone_2018 <- filter(epa_data, year(Date) == 2018)

# Create boxplot for ozone levels by month in 2018
  ggplot(ozone_2018, aes(x = factor(month(Date)), y = Ozone)) +
  geom_boxplot() +
  labs(x = "Month", y = "Ozone Level (ppb)", title = "Ozone Levels by Month (2018)")

```

```{r Ozone2019, echo=FALSE, fig.align='left', warning=FALSE,message=FALSE, fig.cap= "Ozone 2019", fig.height= 3}
# Filter records for 2019
ozone_2019 <- filter(epa_data, year(Date) == 2019)

# Create boxplot for ozone levels by month in 2019
  ggplot(ozone_2019, aes(x = factor(month(Date)), y = Ozone)) +
  geom_boxplot() +
  labs(x = "Month", y = "Ozone Level (ppb)", title = "Ozone Levels by Month (2019)")
```
...
## Git Repository
### [Here is my Git repository](https://github.com/JerryG01/EDA_Spring2024)
