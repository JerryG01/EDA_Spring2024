...
ggplot(PeterPaul.chem.nutrients, aes(x = month_f)) + 
  geom_bar() + 
...
# We are doing coding by "Pipe"
PeterPaul.chem.nutrients %>%
  filter(depth == 0) %>%
  ggplot(
    aes(x = daynum, y = temperature_C, color = year4)) + 
  geom_point(alpha = 0.5) + # Alpha is the transparency of the plot
  facet_wrap()
#2. 
